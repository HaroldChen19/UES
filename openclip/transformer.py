...
class Adapter(nn.Module):
    ...
    def __init__(self, in_channels, adapter_channels, kernel_size):
        ...
        #     kernel_size=16,  # kernel_size等于时间步长16
        #     stride=16  # 将时间维度从16压缩到1
        # )
...
class ResidualAttentionBlock(nn.Module):
    def __init__(
        ...
        self.adapter_pre_mlp = adapter_class()
    ...
    def forward(
        ...
        # print("x:", x.shape) #[257, 128, 1280]
        x = self.adapter_pre_mlp(x, T=16)
